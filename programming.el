  ...
  (message "customizing GNU Emacs for OSX")
    ...
    (add-hook 'c-mode-common-hook          ;; unlike setq, don't forget quote (') before c++-mode-hook
        '(lambda() (ggtags-mode 1)   ;; get into gtags-mode whenever you get into c++-mode
            (setq ggtags-global-command "/opt/local/bin/global")))
    ; and ends here
  )
...
;; hotkeys
(global-set-key "\M-." 'ggtags-find-tag) ;; M-. finds tag
(global-set-key [(control meta .)] 'ggtags-find-rtag) ;; C-M-. find all references of tag
